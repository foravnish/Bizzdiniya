...
//                            mCustomPagerAdapter2.notifyDataSetChanged();
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Api.subcategoryByCategoryId+"?categoryId="+getArguments().getString("id").toString(), null, new Response.Listener<JSONObject>() {
...
//                                });
        ...
        expListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (AllProducts.get(i).get("plus").equalsIgnoreCase("No")) {
                    Fragment fragment = new ListedPage();
                    Bundle bundle = new Bundle();
                    bundle.putString("id", AllProducts.get(i).get("id"));
                    bundle.putString("title", AllProducts.get(i).get("service_name"));
                ...
                else if (AllProducts.get(i).get("plus").equalsIgnoreCase("yes")){

                    Fragment fragment=new SubcategoruPlus();
                    FragmentManager manager=getFragmentManager();
                    Bundle bundle = new Bundle();
                    bundle.putString("id",AllProducts.get(i).get("id"));
                    bundle.putString("title",AllProducts.get(i).get("service_name"));
    ...
    class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            plusSign=convertView.findViewById(R.id.plusSign);
            if (AllProducts.get(position).get("plus").equalsIgnoreCase("No")) {
                textview.setText(AllProducts.get(position).get("service_name"));
                plusSign.setVisibility(View.GONE);
            }
            else if (AllProducts.get(position).get("plus").equalsIgnoreCase("Yes")){
