...
//        }
       ...
       // Log.d("fdsgvdfgfdghfgdfhd", MyPrefrences.getUserID(getActivity()));
        ...
        getActivity().setTitle(getArguments().getString("fragmentKey"));

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Api.searchCompany+"?keyword="+getArguments().getString("fragmentKey").replace(" ","%20")+"&cityId=1", null, new Response.Listener<JSONObject>() {
